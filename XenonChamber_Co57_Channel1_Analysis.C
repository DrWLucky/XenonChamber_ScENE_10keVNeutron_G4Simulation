...
void XenonChamber_Co57_Channel1_Analysis(){
    ...
    std::string AppendString = "Channel1_122keV";
    
    std::string RunName = "Run10001_Co57_0Vcm";
...
//=============================================================================
   ...
   TH1F          *hist_Channel1_Pulse = new TH1F("hist_Channel1_Pulse",  "",    200, 0., 100);
    
    //hist_Channel1_Pulse->SetStats(0);
    hist_Channel1_Pulse->GetXaxis()->SetTitle("S1 [PE]");
    hist_Channel1_Pulse->GetYaxis()->SetTitle("Events/0.5Bin");
    hist_Channel1_Pulse->GetXaxis()->SetTitleSize(0.04);
    hist_Channel1_Pulse->GetYaxis()->SetTitleSize(0.04);
    hist_Channel1_Pulse->SetTitle("122keV S1 from Channel#1 (Top Center PMT) ^{57}Co Calibration, E_{drfit}=0 V/cm");
    hist_Channel1_Pulse->SetLineColor(38);
...
//=============================================================================
    ...
    TH2F          *hist_S1vsPulseMax = new TH2F("hist_S1vsPulseMax", "", 400, 0., 200, 200, 0., 100);
    ...
    hist_S1vsPulseMax->SetTitle("122keV Pulse S1 vs. Pulse Max");
...
//event->GetChannelByID(-2)->pulses[1].start_time
    ...
    Double_t  Channel1_S1_PE    = T1Event->GetChannelByID(0)->pulses[0].npe;
    Double_t  Channel1_S1_Peak  = T1Event->GetChannelByID(0)->pulses[0].peak_amplitude;

    Double_t  Channel1_S1_PulseWidth  = 1000*(T1Event->GetChannelByID(0)->pulses[0].end_time - T1Event->GetChannelByID(0)->pulses[0].start_time);
    ...
    if(!Saturated){
        ...
        if( (S1_PE>1000)&&(S1_PE<1400) ){
            hist_Channel1_Pulse->Fill(Channel1_S1_PE);
            hist_Channel1_PulseWidth->Fill(Channel1_S1_PulseWidth);
            hist_Channel1_PulsePeak->Fill(Channel1_S1_Peak);
